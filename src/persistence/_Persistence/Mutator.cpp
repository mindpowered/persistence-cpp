...
HX_DEFINE_STACK_FRAME(_hx_pos_9dae053d9ec60bd7_293_new,"persistence._Persistence.Mutator","new",0xb5d6dd75,"persistence._Persistence.Mutator.new","persistence/Persistence.hx",293,0x9767c4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_9dae053d9ec60bd7_287_boot,"persistence._Persistence.Mutator","boot",0x5e43e97d,"persistence._Persistence.Mutator.boot","persistence/Persistence.hx",287,0x9767c4cf)
...
void Mutator_obj::__construct(::String recordType, ::Dynamic strategyMethod, ::Dynamic updateMapper,bool useRecordDataAsParams){
            	HX_STACKFRAME(&_hx_pos_9dae053d9ec60bd7_293_new)
HXLINE( 294)		bool _hx_tmp;
HXDLIN( 294)		if (!(::Std_obj::isOfType(strategyMethod,( ( ::Dynamic)(::hx::ClassOf< ::String >()) )))) {
HXLINE( 294)			_hx_tmp = !(::Reflect_obj::isFunction(strategyMethod));
            		}
            		else {
HXLINE( 294)			_hx_tmp = false;
            		}
HXDLIN( 294)		if (_hx_tmp) {
HXLINE( 295)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("strategyMethod must be a string or function",97,7a,0d,90)));
            		}
HXLINE( 297)		bool _hx_tmp1;
HXDLIN( 297)		if (!(::Std_obj::isOfType(updateMapper,( ( ::Dynamic)(::hx::ClassOf< ::String >()) )))) {
HXLINE( 297)			_hx_tmp1 = !(::Reflect_obj::isFunction(updateMapper));
            		}
            		else {
HXLINE( 297)			_hx_tmp1 = false;
            		}
HXDLIN( 297)		if (_hx_tmp1) {
HXLINE( 298)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("updateMapper must be a string or function",e1,0d,80,87)));
            		}
HXLINE( 300)		this->recordType = recordType;
HXLINE( 301)		this->strategyMethod = strategyMethod;
HXLINE( 302)		this->updateMapper = updateMapper;
HXLINE( 303)		this->useRecordDataAsParams = useRecordDataAsParams;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_9dae053d9ec60bd7_287_boot)
HXDLIN( 287)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
