...
HX_DEFINE_STACK_FRAME(_hx_pos_9dae053d9ec60bd7_299_new,"persistence._Persistence.Mutator","new",0xb5d6dd75,"persistence._Persistence.Mutator.new","persistence/Persistence.hx",299,0x9767c4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_9dae053d9ec60bd7_293_boot,"persistence._Persistence.Mutator","boot",0x5e43e97d,"persistence._Persistence.Mutator.boot","persistence/Persistence.hx",293,0x9767c4cf)
...
void Mutator_obj::__construct(::String recordType, ::Dynamic strategyMethod, ::Dynamic updateMapper,bool useRecordDataAsParams){
            	HX_STACKFRAME(&_hx_pos_9dae053d9ec60bd7_299_new)
HXLINE( 300)		bool _hx_tmp;
HXDLIN( 300)		if (!(::Std_obj::isOfType(strategyMethod,( ( ::Dynamic)(::hx::ClassOf< ::String >()) )))) {
HXLINE( 300)			_hx_tmp = !(::Reflect_obj::isFunction(strategyMethod));
            		}
            		else {
HXLINE( 300)			_hx_tmp = false;
            		}
HXDLIN( 300)		if (_hx_tmp) {
HXLINE( 301)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("strategyMethod must be a string or function",97,7a,0d,90)));
            		}
HXLINE( 303)		bool _hx_tmp1;
HXDLIN( 303)		if (!(::Std_obj::isOfType(updateMapper,( ( ::Dynamic)(::hx::ClassOf< ::String >()) )))) {
HXLINE( 303)			_hx_tmp1 = !(::Reflect_obj::isFunction(updateMapper));
            		}
            		else {
HXLINE( 303)			_hx_tmp1 = false;
            		}
HXDLIN( 303)		if (_hx_tmp1) {
HXLINE( 304)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("updateMapper must be a string or function",e1,0d,80,87)));
            		}
HXLINE( 306)		this->recordType = recordType;
HXLINE( 307)		this->strategyMethod = strategyMethod;
HXLINE( 308)		this->updateMapper = updateMapper;
HXLINE( 309)		this->useRecordDataAsParams = useRecordDataAsParams;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_9dae053d9ec60bd7_293_boot)
HXDLIN( 293)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
